...
HEADERS += qrtailab_listener.h targets_manager.h logs_manager.h scope_trace.h
...
SOURCES +=   qrtailab_core.cpp qrtailab_listener.cpp targets_manager.cpp logs_manager.cpp scope_trace.cpp
